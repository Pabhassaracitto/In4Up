...
extern "C"
{
    ...
    __attribute__((visibility("default")))
    int32_t
    uts_initialize(int32_t sampleRate, int32_t channels, int32_t quality)
    {
        try
        {
            if (g_engine)
            ...
            {
            case 0:
                options.quality = UltraTimeStretch::Quality::Preview;
                break;
            case 1:
    ...
    // Shutdown engine
    __attribute__((visibility("default"))) void uts_shutdown()
    {
        if (g_engine)
        {
            g_engine->shutdown();
    ...
    __attribute__((visibility("default"))) void uts_set_speed(float speed)
    {
        if (g_engine)
        {
    ...
    __attribute__((visibility("default"))) void uts_set_pitch(float semitones)
    {
        if (g_engine)
        {
    ...
    // Get current speed
    __attribute__((visibility("default"))) float uts_get_speed()
    {
        if (g_engine)
        {
    ...
    // Get current pitch
    __attribute__((visibility("default"))) float uts_get_pitch()
    {
        if (g_engine)
        {
    ...
    // Reset engine state
    __attribute__((visibility("default"))) void uts_reset()
    {
        if (g_engine)
        {
            g_engine->reset();
    ...
    __attribute__((visibility("default"))) void uts_flush()
    {
        if (g_engine)
        {
            g_engine->flush();
    ...
    __attribute__((visibility("default")))
    int32_t
    uts_get_output_buffer_size(int32_t inputSamples)
    {
        if (g_engine)
        {
