...
| LISTEN-823-01 | Tab Nghe: rèm LRC + AI sheet + dịch Hiểu + transcript đúng audio | 🔄 reopened | RCA: provider chưa được inject toàn cục + cache fallback không gắn source |
...
- **Trạng thái:** reopened (đang sửa transcript cũ bám audio mới)
