...
const Map<String, Map<String, String>> priorityUiOverrides = {
  ...
  // CABIN-SAVE-001 (PLAN-030) — lưu phiên Cabin.
  'Lưu phiên Cabin': {
    'en': 'Save Cabin session',
    'hi': 'कैबिन सत्र सहेजें',
    'zh': '保存同传会话',
    'zh_TW': '儲存同傳工作階段',
    'si': 'කැබින් සැසිය සුරකින්න',
  },
  'Tên phiên': {
    'en': 'Session name',
    'hi': 'सत्र का नाम',
  ...
  'Lưu & mở trong Tab Đọc': {
    'en': 'Save & open in Read tab',
    'hi': 'सहेजें और पढ़ें टैब में खोलें',
    'zh': '保存并在阅读页打开',
    'zh_TW': '儲存並在閱讀頁開啟',
    'si': 'සුරකින්න සහ කියවීම් ටැබයේ විවෘත කරන්න',
  },
  'Mở trong Tab Đọc': {
    'en': 'Open in Read tab',
    'hi': 'पढ़ें टैब में खोलें',
    'zh': '在阅读页打开',
    'zh_TW': '在閱讀頁開啟',
    'si': 'කියවීම් ටැබයේ විවෘත කරන්න',
  },
  'Bỏ phiên': {
    'en': 'Discard session',
    'hi': 'सत्र छोड़ें',
  ...
  'Đã lưu phiên Cabin': {
    'en': 'Cabin session saved',
    'hi': 'कैबिन सत्र सहेजा गया',
    'zh': '已保存同传会话',
    'zh_TW': '已儲存同傳工作階段',
    'si': 'කැබින් සැසිය සුරකින ලදී',
  },
  'Không mở được văn bản trong Tab Đọc': {
    'en': 'Could not open the text in the Read tab',
    'hi': 'पढ़ें टैब में टेक्स्ट नहीं खुल सका',
    'zh': '无法在阅读页打开文本',
    'zh_TW': '無法在閱讀頁開啟文字',
    'si': 'කියවීම් ටැබයේ පෙළ විවෘත කළ නොහැක',
  },
  'Phiên này không có ghi âm (engine hệ thống không cho ghi song song).': {
    'en': 'This session has no recording (the system engine does not allow parallel recording).',
    'hi': 'इस सत्र में रिकॉर्डिंग नहीं है (सिस्टम इंजन साथ-साथ रिकॉर्डिंग की अनुमति नहीं देता)।',
    'zh': '此会话没有录音（系统引擎不允许同时录音）。',
    'zh_TW': '此工作階段沒有錄音（系統引擎不允許同時錄音）。',
    'si': 'මෙම සැසියේ පටිගත කිරීමක් නැත (පද්ධති එන්ජිම සමාන්තර පටිගත කිරීමට ඉඩ නොදේ).',
  },
  'Phiên khôi phục sau khi ứng dụng bị tắt ngang': {
    'en': 'Session recovered after the app closed unexpectedly',
    'hi': 'ऐप अचानक बंद होने के बाद सत्र पुनर्प्राप्त हुआ',
    'zh': '应用意外关闭后恢复的会话',
    'zh_TW': '應用程式意外關閉後復原的工作階段',
    'si': 'යෙදුම අනපේක්ෂිතව වැසීමෙන් පසු සැසිය ප්‍රතිසාධනය විය',
  },
  'Cài đặt lưu phiên': {
    'en': 'Session saving settings',
    'hi': 'सत्र सहेजने की सेटिंग',
    'zh': '会话保存设置',
    'zh_TW': '工作階段儲存設定',
    'si': 'සැසි සුරැකීමේ සැකසුම්',
  },
  'Ghi âm khi dịch (engine Offline)': {
    'en': 'Record while translating (Offline engine)',
    'hi': 'अनुवाद करते समय रिकॉर्ड करें (ऑफ़लाइन इंजन)',
    'zh': '翻译时录音（离线引擎）',
    'zh_TW': '翻譯時錄音（離線引擎）',
    'si': 'පරිවර්තනය කරන අතරතුර පටිගත කරන්න (නොබැඳි එන්ජිම)',
  },
  'Tự lưu khi dừng, không hỏi': {
    'en': 'Auto-save on stop, don\'t ask',
    'hi': 'रोकने पर अपने-आप सहेजें, न पूछें',
    'zh': '停止时自动保存，不询问',
    'zh_TW': '停止時自動儲存，不詢問',
    'si': 'නැවැත්වූ විට ස්වයංක්‍රීයව සුරකින්න, නොඅසන්න',
  },
  'Định dạng ghi âm': {
    'en': 'Recording format',
    'hi': 'रिकॉर्डिंग फ़ॉर्मेट',
    'zh': '录音格式',
    'zh_TW': '錄音格式',
    'si': 'පටිගත කිරීමේ ආකෘතිය',
  },
  'WAV (không nén)': {
    'en': 'WAV (uncompressed)',
    'hi': 'WAV (असंपीड़ित)',
    'zh': 'WAV（未压缩）',
    'zh_TW': 'WAV（未壓縮）',
    'si': 'WAV (සම්පීඩනය නොකළ)',
  },
  'Nén (sắp có)': {
    'en': 'Compressed (coming soon)',
    'hi': 'संपीड़ित (जल्द आ रहा है)',
    'zh': '压缩（即将推出）',
    'zh_TW': '壓縮（即將推出）',
    'si': 'සම්පීඩිත (ළඟදීම)',
  },
  ...
  'Chỉ lưu được văn bản — chuyển sang engine Offline để ghi âm': {
    'en': 'Text only — switch to the Offline engine to record audio',
    'hi': 'केवल टेक्स्ट — ऑडियो रिकॉर्ड करने के लिए ऑफ़लाइन इंजन चुनें',
    'zh': '仅保存文本 — 切换到离线引擎以录音',
    'zh_TW': '僅儲存文字 — 切換到離線引擎以錄音',
    'si': 'පෙළ පමණි — ශ්‍රව්‍ය පටිගත කිරීමට නොබැඳි එන්ජිමට මාරු වන්න',
  },
};
