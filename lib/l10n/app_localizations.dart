...
abstract class AppLocalizations {
  ...
  String grammarCustomizingFrom(String name);
  ...
  String grammarHiddenDesc(String count);

  /// No description provided for @grammarHiddenGroups.
  /// In en, this message translates to:
  /// **'{count} groups hidden'**
  String grammarHiddenGroups(String count);
  ...
  /// In en, this message translates to:
  /// **'Restore {name}'**
  String grammarRestore(String name);
  ...
  /// In en, this message translates to:
  /// **'Using preset: {name}'**
  String grammarUsingPreset(String name);
  ...
  /// In en, this message translates to:
  /// **'Continue from {time}'**
  String listenContinue(String time);
...
/// to start growing your knowledge garden'**
  ...
  /// In en, this message translates to:
  /// **'Please enter {field}'**
  String msgPleaseEnter(String field);
...
/// Supports TXT, LRC, SRT'**
  ...
  /// In en, this message translates to:
  /// **'Max: {seconds}s'**
  String shadowingMax(String seconds);
...
/// 3. Repeat after sample'**
  ...
  /// In en, this message translates to:
  /// **'{count} features'**
  String toolsFeaturesCount(String count);
  ...
  String translationChangedTo(String flag, String language);
...
/// or use Set Loop button'**
  ...
  /// In en, this message translates to:
  /// **'Get captions ({lang})'**
  String ytGetCaptions(String lang);
  ...
  String ytMoreLines(String count);
...
/// Try another language.'**
  String ytNoCaptionsLang(String lang);
  ...
  String ytPreparingQuality(String kbps, String size);
  ...
  /// In en, this message translates to:
  /// **'Quality: {quality}'**
  String ytQualityLabel(String quality);
