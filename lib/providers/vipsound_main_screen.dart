...
class VipSoundMainScreen extends StatefulWidget {
  const VipSoundMainScreen({super.key});

  @override
  State<VipSoundMainScreen> createState() => _VipSoundMainScreenState();
}

class _VipSoundMainScreenState extends State<VipSoundMainScreen> {
  int _currentIndex = 0;
