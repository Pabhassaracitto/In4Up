//
// Word List — màn hình đầy đủ mở từ Tools overlay.
// Hiển thị danh sách từ vựng từ Memory Mode + tự thêm.
...
// ─────────────────────────────────────────────────────────────
// Repeat Selector — số lần lặp TTS (1–5)
// ─────────────────────────────────────────────────────────────
      ...
      builder: (_) => Padding(
        ...
        child: Column(
          ...
          children: [
            ...
            const SizedBox(height: 6),
            Text(
              'Từ khó có thể phát nhiều lần để ghi nhớ',
      ...
      child: Column(
        ...
        children: [
          ...
          _ToggleRow(
            ...
            onChanged: (v) => _update(_s.copyWith(showShortDefinition: v)),
          ),
          _ToggleRow(
            label: 'Nghĩa đầy đủ (Full Definition)',
            icon: Icons.article_outlined,
            value: _s.showFullDefinition,
            onChanged: (v) => _update(_s.copyWith(showFullDefinition: v)),
          ),
          _ToggleRow(
