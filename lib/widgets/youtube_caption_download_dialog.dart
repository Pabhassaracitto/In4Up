...
class _YoutubeCaptionDownloadDialogState
  ...
  Future<void> _fetchInfo() async {
    ...
    try {
      ...
      setState(() {
        ...
        if (langs.isNotEmpty &&
            !langs.any((l) => l.code == _selectedLang)) {
  ...
  Future<void> _downloadCaptions() async {
    ...
    try {
      ...
      if (captions.isEmpty) {
        setState(() {
          _errorMessage =
              'Không có captions cho ngôn ngữ "$_selectedLang".\n'
      ...
      // Lưu .lrc file
      final lrcPath =
          await _svc.saveCaptionsAsLrc(captions, _videoInfo!);
  ...
  void _loadLrcIntoSyncMode(BuildContext ctx) {
    ...
    ScaffoldMessenger.of(ctx).showSnackBar(SnackBar(
      content: const Text(
          '✅ LRC loaded — dùng được trong Understand Mode (sync)'),
    ...
    return Row(
      children: [
        Container(
          ...
          child: const Icon(Icons.subtitles, color: Color(0xFF2196F3), size: 22),
        ),
          ...
          children: [
            ...
            Expanded(
              ...
              child: ElevatedButton.icon(
                ...
                label:
                    Text('Tải captions ($_selectedLang)'),
                style: ElevatedButton.styleFrom(
                  backgroundColor: const Color(0xFF4CAF50),
          ...
          Container(
            ...
            child: Column(
              children: _captions.take(3).map((c) {
                final mm = c.start.inMinutes
                    .remainder(60)
                    .toString()
                    .padLeft(2, '0');
                final ss = c.start.inSeconds
                    .remainder(60)
                    .toString()
                    .padLeft(2, '0');
                return Padding(
