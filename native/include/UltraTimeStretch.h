...
namespace UltraTimeStretch
{
    ...
    //==============================================================================
    constexpr int MAX_FFT_SIZE = 16384; // Tăng từ 8192 cho V2
    ...
    public:
        ...
        // Real input -> Complex output (với windowing)
    ...
    protected:
        ...
        std::vector<float> frameOutput_; // <-- THÊM DÒNG NÀY
    ...
    private:
        int findBestOffset(const float *current, const float *previous, int searchRange);
    ...
    protected: // Changed from private to protected for V2 inheritance
        bool initialized_;
        int sampleRate_;
        int channels_;
        float speed_;
