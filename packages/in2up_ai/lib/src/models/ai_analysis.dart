// packages/in2up_ai/lib/src/models/ai_analysis.dart
  ...
  factory AiAnalysis.fromJson(Map<String, dynamic> json, String inputText) {
    return AiAnalysis(
      ...
      wordDetail: json['word_detail'] != null
          ? WordAnalysis.fromJson(json['word_detail'] as Map<String, dynamic>)
          : null,
      visualPrompt: json['visual_prompt'] as String?,
      ipaFallback: json['ipa_fallback'] as String?,
      paoSuggestions: (json['pao_suggestions'] as List?)
              ?.map((e) => e.toString())
              .toList() ??
          [],
      contextExamples: (json['context_examples'] as List?)
              ?.map((e) => e.toString())
              .toList() ??
          [],
      success: true,
