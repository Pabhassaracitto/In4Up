...
/// Orchestrator chính - tích hợp với Provider pattern của in4up
...
class AiServiceFacade extends ChangeNotifier {
  ...
  /// Send one conversational turn. History is included as context.
  ...
  /// ErrorLogEntry được xử lý bởi in4up_storage, không phải ở đây
