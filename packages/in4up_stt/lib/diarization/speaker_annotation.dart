// in4up v11.0 — Diarization overlay (không mutate SttSegment)
...
class SpeakerAnnotation {
  ...
  factory SpeakerAnnotation.fromJson(Map<String, dynamic> j) =>
      SpeakerAnnotation(
        ...
        pipelineVersion: j['pipelineVersion'] as String? ?? 'diar-v11',
      );

  @override
  String toString() => 'SpeakerAnnotation(uid=$segmentUid, '
